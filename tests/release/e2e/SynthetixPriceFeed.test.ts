import { ISynthetixAddressResolver, ISynthetixExchangeRates, StandardToken } from '@risqprotocol/protocol';
import { ForkDeployment, loadForkDeployment, synthetixResolveAddress } from '@risqprotocol/testutils';
